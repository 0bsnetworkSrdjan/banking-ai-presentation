...
# When you ask the agent to "update slides", it processes only slides marked
# with -edited in their id (plus new/deleted slides), then updates slides.js.
# Content is always authored in English.
...
<!-- ================================================================
  ...
  and it will update slides.js incrementally.

  IMPORTANT: Each slide has a stable 10-char id in frontmatter.
  If you edit a slide, append "-edited" to that id.
  Example: id: Ab3kL9xPq2-edited
  The agent processes that slide and removes "-edited" after completion.
  ...
  ──────────────────
  id       (required)
    Stable 10-char alphanumeric identifier for this slide.
    If you edited this slide, append "-edited" before running update.
    Example: id: Ab3kL9xPq2-edited
